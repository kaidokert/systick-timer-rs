...
"""
    ...
    print("STM32F412 Nucleo Systick Timer - Comprehensive Test Runner")
    print("="*80)

    # Check if we're in the right directory
    try:
        with open("Cargo.toml", "r") as f:
            if "stm32f412-nucleo" not in f.read():
                print("ERROR: Please run this script from testapps/stm32f412-nucleo directory")
                sys.exit(1)
